...
namespace Car_RentalDb.Areas.Identity.Data
{
    public class DbInitializer
    {
            ...
            var cars = new Car[]
        {
                ...
                new Car {StaffID=5,LocationID=1,Model = "Kia Niro", Year =2016, DailyRate = 480, FuelType = "Petrol", IsAvailable = "No" },
                new Car {StaffID=6, LocationID = 1, Model = "Ford Escape", Year =2014, DailyRate = 781, FuelType = "Petrol", IsAvailable = "Yes" },
                new Car {StaffID=7, LocationID = 1, Model = "Toyota Rav4", Year =2010, DailyRate = 430, FuelType = "Petrol", IsAvailable = "Yes" },
                new Car {StaffID=8, LocationID = 1, Model = "Mitsubishi Triton Canopy", Year =2019, DailyRate = 806, FuelType = "Diesel", IsAvailable = "No" },
